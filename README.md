...
## Description
This provides two Vuci endpoints for Teltonika RUTX10 routers that communicate with [my ubus module for OpenVPN.](http://84.15.161.187/matbin/ubus-openvpn-module)
